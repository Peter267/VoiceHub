<template>
  <div class="blacklist-manager">
    <div class="header">
      <h3>电影黑名单管理</h3>
      <p class="description">管理禁止点播的电影和关键词</p>
    </div>
        ...
        <div class="form-row">
          <div class="form-group">
            ...
            <select v-model="newItem.type" class="form-select">
              <option value="SONG">具体电影</option>
              <option value="KEYWORD">关键词</option>
            </select>
          </div>
          <div class="form-group flex-1">
            <label>{{ newItem.type === 'SONG' ? '电影名称 - 艺术家' : '关键词' }}:</label>
            <input
              v-model="newItem.value"
              type="text"
              :placeholder="newItem.type === 'SONG' ? '例如: 电影名 - 艺术家' : '例如: 敏感词'"
              class="form-input"
            />
          </div>
        </div>
