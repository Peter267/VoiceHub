      ...
      <div class="modal-body">
        <div class="import-instructions">
          ...
          <p class="import-note">
            ...
            <span v-if="isSuperAdmin">USER（普通用户）、ADMIN（管理员）、SONG_ADMIN（电影管理员）、SUPER_ADMIN（超级管理员）</span>
            <span v-else>USER（普通用户）、SONG_ADMIN（电影管理员）</span>
          </p>
        </div>
...
const allRoles = [
  ...
  { name: 'SONG_ADMIN', displayName: '电影管理员' },
