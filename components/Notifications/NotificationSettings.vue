    ...
    <div v-else class="settings-form">
      <div class="form-group">
        <label class="toggle-label">
          <span class="label-text">电影被选中通知</span>
        ...
        <p class="setting-description">当您投稿的电影被选中安排播放时通知您</p>
      </div>
      
      <div class="form-group">
        <label class="toggle-label">
          <span class="label-text">电影已播放通知</span>
          <div class="toggle-switch">
            <input 
              type="checkbox" 
        ...
        <p class="setting-description">当您投稿的电影被播放时通知您</p>
      </div>
      
      <div class="form-group">
        <label class="toggle-label">
          <span class="label-text">电影获得投票通知</span>
          <div class="toggle-switch">
            <input 
              type="checkbox" 
        ...
        <p class="setting-description">当您投稿的电影获得新投票时通知您</p>
