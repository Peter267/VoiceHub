...
export const useAdmin = () => {
  ...
  const deleteSong = async (songId: number) => {
    ...
    try {
      ...
      error.value = err.message || '删除电影失败'
      throw err
    } finally {
      loading.value = false
    }
  ...
  const updateSong = async (songId: number, songData: any) => {
    ...
    try {
      ...
      error.value = err.message || '更新电影失败'
      throw err
    } finally {
      loading.value = false
    }
  ...
  const addSong = async (songData: any) => {
    ...
    try {
      ...
      error.value = err.message || '添加电影失败'
      throw err
    } finally {
      loading.value = false
    }
