...
export const useSiteConfig = () => {
  ...
  // 计算属性
  const siteTitle = computed(() => siteConfig.value.siteTitle || '班级多媒体点播系统')
  ...
  const description = computed(() => siteConfig.value.siteDescription || '班级多媒体点播系统 - 让你的声音被听见')
